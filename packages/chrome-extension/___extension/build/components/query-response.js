"use strict";
const queryResponseElement = createElement('div', {
    "position": "fixed",
    "bottom": "72px",
...
}, 'chatgpt-that-query-response-element', [], '', true);
const queryResponseCopyIconElement = createElement('div', {
    "position": "absolute",
    "bottom": "14px",
    "right": "16px",
    "display": "flex",
  ...
  `, false);
const getMoreCreditsElement = createElement('span', {
    "position": "relative",
    "text-decoration": "underline",
    "cursor": "pointer",
    "margin-left": "3px"
}, undefined, [], 'Get more credits', false);
...
const showQueryResponseWithMessage = (message, isErrorMessage, onGetMoreCredits) => {
