"use strict";
const selectionBoxElement = createElement('div', {
    "visibility": "hidden",
    "position": "fixed",
...
}, 'chatgpt-that-selection-box-element', [], '', true);
...
const updateSelectionBoxElementPosition = (x, y) => {
    selectionBoxElement.style.left = `${x}px`;
    selectionBoxElement.style.top = `${y}px`;
};
const updateSelectionBoxElementSize = (width, height) => {
