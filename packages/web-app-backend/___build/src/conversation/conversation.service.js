...
export class ConversationService {
    ...
    async addToConversation(addToConversationDto) {
        ...
        const updatedConversationWithUserMessage = existingConversation ? [...existingConversation.conversation, userMessage] : [userMessage];
    ...
    async deleteConversation(deleteConversationDto) {
